...
pub const Node = struct {
    ...
    rx1_delay_s: ?u8,
    adr_use: AdrConfig,
    adr_observation_count: u16,
    adr_average_rssi: ?f64,
    adr_average_lsnr: ?f64,
    adr_last_data_rate: ?u8,
    ...
    pub fn init(dev_addr: [4]u8, app_s_key: [16]u8, nwk_s_key: [16]u8, rxwin_use: RxWindowConfig, adr_use: AdrConfig) Node {
        return .{
            ...
            .rx1_delay_s = null,
            .adr_use = adr_use,
            .adr_observation_count = 0,
            .adr_average_rssi = null,
            .adr_average_lsnr = null,
            .adr_last_data_rate = null,
            .channel_masks = null,
