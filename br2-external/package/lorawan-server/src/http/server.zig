...
const routes = [_]router_mod.Route{
    ...
    router_mod.Route.init(.POST, "/api/users", users_handler.create, &api_middlewares),
    router_mod.Route.init(.GET, "/api/users/:id", users_handler.get, &api_middlewares),
    router_mod.Route.init(.PUT, "/api/users/:id", users_handler.update, &api_middlewares),
    router_mod.Route.init(.DELETE, "/api/users/:id", users_handler.delete, &api_middlewares),
